...
if(isset($_GET['func'])) {
	...
	echo '<a class="btn btn-success" href="index.php?route=term-frequency&func=run" role="button">Extract Term Frequency</a>';
	echo '<hr />';
}
...
// count english rows in the collection
$terms = $termCollection->count();
echo 'Terms: <strong>'.$terms.'</strong><br />';
...
$terms = $termCollection->find()->limit($limitRow);
